function dst = IntraDecodeInt(image, img_size , qScale, EoB, zr_setter, ycbcr)
...
% rec_imageYCbCr_Idct = blockproc(rec_imageYCbCr_dequant, ...
%         [4, 4], @(block_struct) IInt4x4(block_struct.data));
rec_imageYCbCr_Idct = blockproc(rec_imageYCbCr_dequant, ...
        [8, 8], @(block_struct) IDCT8x8(block_struct.data));
