function [motion_vectors_indices, ssd] = SSD16x16(ref_image, image)
...
motion_vectors_indices = blockproc(image, [16, 16], @(block_struct) BlockSSDMV(block_struct.data, block_struct.location, ref_image));
ssd = blockproc(image, [16, 16], @(block_struct) BlockSSD(block_struct.data, block_struct.location, ref_image));
