function [motion_vectors_indices, ssd] = SSD8x8(ref_image, image)
...
motion_vectors_indices = blockproc(image, [8, 8], @(block_struct) BlockSSDMV(block_struct.data, block_struct.location, ref_image));
ssd = blockproc(image, [8, 8], @(block_struct) BlockSSD(block_struct.data, block_struct.location, ref_image));
